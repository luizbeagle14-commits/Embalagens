...
<head>
  ...
  <style>
    ...
    textarea{width:100%;min-height:350px;max-height:600px;border:1px solid #ccc;border-radius:6px;padding:10px;font-family:inherit;resize:vertical;overflow:auto;line-height:1.5;font-size:1rem;}
